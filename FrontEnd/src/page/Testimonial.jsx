...
import TestimonyForm from "../assets/Form-Fields/TestimonyForm"
import Delete from "../api/delete";
import testimonyTable from "../assets/Table-Head/testimonyTable";
...
const Testimony = () => {
  ...
  const { data } = useReadData(
    "http://localhost/cms/dashboard/api/testimonyApi/getTestimony.php"
  );
